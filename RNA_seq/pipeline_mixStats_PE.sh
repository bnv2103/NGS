...
f1="111111_lane_1_3-48hr_3_1.fastq_pe-cufflinks-hm/accepted_hits.bam"
f2="111111_lane_1_3-48hr_3_1.fastq_pe-cufflinks-ms/accepted_hits.bam"
# f1=$1
# f2=$2
...
grep -f commReadsPE.txt <(samtools view -X $f1) > common.sam 
