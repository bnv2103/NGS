...
# /ifs/scratch/c2b2/ngs_lab/sz2317/scripts/Pipeline/demultiplex_n.rb
cmd="$RUBY18 /ifs/scratch/c2b2/ngs_lab/sz2317/scripts/Pipeline/demultiplex.rb $fastqout $demultiplexout $outprefix $demultiplexout/$runName.tsv 8"
