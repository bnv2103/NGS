...
starts = {reads.Position};
reads = cigar2align({reads.Sequence}, {reads.CigarString});

nreads = size(reads,1);

[FileName,PathName,FilterIndex] = uigetfile('/ifs/home/c2b2/ngs_lab/ngs/data/resources/ionTorrent_hg19/hg19.fasta','select reference FASTA file');
